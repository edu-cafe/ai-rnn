        ...
        for epoch in range(n_epochs):
            ...
            if min_tot_loss > tot_loss or epoch+1 == n_epochs:
                ...
                if PMLR and dim_z == 2:
                    ...
                    PMLR.save_scattered_image(z_PMLR,id_PMLR, name="/PMLR_map_epoch_%02d" % (epoch) + ".png")

"""
1) run run_main --dim_z 2 
   run run_main --dim_z 10
   run run_main --dim_z 20
   run run_main --dim_z 2 --num_epochs 60  # default 20, 20
2) run run_main --dim_z 20 --add_noise True --num_epochs 40
3) run run_main --dim_z 2 --num_epochs 60 --PMLR True
"""
...
"""
epoch 35: L_tot 146.46 L_likelihood 133.29 L_divergence 13.17
epoch 36: L_tot 146.48 L_likelihood 133.26 L_divergence 13.22
epoch 37: L_tot 148.67 L_likelihood 135.87 L_divergence 12.80
epoch 38: L_tot 140.72 L_likelihood 127.77 L_divergence 12.96
epoch 39: L_tot 143.32 L_likelihood 129.61 L_divergence 13.71
"""